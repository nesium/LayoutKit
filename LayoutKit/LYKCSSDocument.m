...
- (void)applyRule:(KatanaStyleRule *)rule toView:(UIView *)aView
{
    ...
    LYKEnumerateKatanaArrayWithBlock(rule->declarations, ^(void *obj, NSUInteger idx, BOOL *stop) {
        ...
        if (strcmp(p, "display") == 0) {
            ...
            aView.backgroundColor = [UIColor colorWithString:
            	[NSString stringWithCString:firstValue->string encoding:NSUTF8StringEncoding]];
            ...
            switch (decl->values->length) {
                case 1:
                    CSSNode->style.padding[CSS_TOP] =
                        ((KatanaValue *)decl->values->data[0])->fValue;
                    CSSNode->style.padding[CSS_LEFT] =
                        ((KatanaValue *)decl->values->data[0])->fValue;
                    CSSNode->style.padding[CSS_BOTTOM] =
                        ((KatanaValue *)decl->values->data[0])->fValue;
                    CSSNode->style.padding[CSS_RIGHT] =
                        ((KatanaValue *)decl->values->data[0])->fValue;
                    break;
                ...
                case 2:
                    CSSNode->style.padding[CSS_TOP] =
                        ((KatanaValue *)decl->values->data[0])->fValue;
                    CSSNode->style.padding[CSS_LEFT] =
                        ((KatanaValue *)decl->values->data[1])->fValue;
                    CSSNode->style.padding[CSS_BOTTOM] =
                        ((KatanaValue *)decl->values->data[0])->fValue;
                    CSSNode->style.padding[CSS_RIGHT] =
                        ((KatanaValue *)decl->values->data[1])->fValue;
                ...
                case 3:
                    ...
                    CSSNode->style.padding[CSS_LEFT] =
                        ((KatanaValue *)decl->values->data[1])->fValue;
                    CSSNode->style.padding[CSS_BOTTOM] =
                        ((KatanaValue *)decl->values->data[2])->fValue;
                    CSSNode->style.padding[CSS_RIGHT] =
                        ((KatanaValue *)decl->values->data[1])->fValue;
                    break;
                ...
                case 4:
                    ...
                    CSSNode->style.padding[CSS_BOTTOM] =
                        ((KatanaValue *)decl->values->data[2])->fValue;
                    CSSNode->style.padding[CSS_RIGHT] =
                        ((KatanaValue *)decl->values->data[3])->fValue;
                    break;
            }
